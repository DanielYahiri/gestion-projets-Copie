    ...
    <div className="df-overlay" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="df-modal" style={{ width: '100%', maxWidth: '480px', maxHeight: '90vh', overflowY: 'auto', margin: '16px' }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div><label style={labelStyle}>Rôle</label><select name="role" value={form.role} onChange={changer} className="df-input"><option value="data_scientist">Data Scientist</option><option value="data_scientist_junior">Data Scientist Jr</option><option value="data_analyst">Data Analyst</option><option value="data_engineer">Data Engineer</option><option value="ml_engineer">ML Engineer</option><option value="chef_de_projet">Chef de projet</option><option value="stagiaire">Stagiaire</option><option value="collaborateur">Collaborateur</option></select></div>
